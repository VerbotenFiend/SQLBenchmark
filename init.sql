...
-- Film (tabella attesa dal testing: "movies" con colonne "titolo", "anno", "genere")
...
-- Disponibilità su piattaforme (nome storico "dove_vederlo")
...
-- Indici utili (coerenti coi nomi italiani)
